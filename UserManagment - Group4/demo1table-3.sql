...
INSERT INTO User (userid, firstname, lastname, address, email, phonenumber, password, role) VALUES
(1, 'Jane', 'Doe', '123 Elm Street', 'jane.doe@example.com', '555-1234', '$2b$10$zHAz4P/YUa7r9LRmbtx/xeZetmo6hX19qNdOJl5UbndCChmwyOCzW', 'customer');

INSERT INTO User (userid, firstname, lastname, address, email, phonenumber, password, role) VALUES
(2, 'Mike', 'Walters', '123 Elm Street', 'mike@walters.com', '123-4567', '$2b$10$zHAz4P/YUa7r9LRmbtx/xeZetmo6hX19qNdOJl5UbndCChmwyOCzW', 'customer');
...
INSERT INTO Restaurant (restaurantid, name, address, email, phonenumber, category, password) VALUES
(3, 'Chipotle', '99 test avenue', 'chipotle@gmail.com', '555-5678', 'Mexican', '$2b$10$zHAz4P/YUa7r9LRmbtx/xeZetmo6hX19qNdOJl5UbndCChmwyOCzW');
